...
/**
 * Global ⌘K / Ctrl+K search: jump to any of the other Taliferro apps.
 * Self-contained (own keybinding, overlay, and result list) so it can just
 * be dropped into an app's root component.
 */
@Component( {
